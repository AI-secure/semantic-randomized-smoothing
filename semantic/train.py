...
#   https://github.com/bearpaw/pytorch-classification written by Wei Yang
...
parser.add_argument('transtype', type=str, help='type of semantic transformations',
                    choices=['rotation-noise', 'noise', 'rotation', 'strict-rotation-noise', 'translation', 'brightness', 'resize', 'gaussian', 'btranslation', 'expgaussian'])
